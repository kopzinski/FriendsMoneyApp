...
exports.default = {
  just_now: 'Agora',
  seconds_ago: 'Há {{time}} segundos atrás',
  a_minute_ago: 'Há 1 minuto',
  minutes_ago: 'Há {{time}} minutos atrás',
  an_hour_ago: 'Há 1 hora atrás',
  hours_ago: 'Há {{time}} horas atrás',
  a_day_ago: 'Ontem',
  days_ago: 'Há {{time}} days ago',
  a_week_ago: 'Há uma semana atrás',
